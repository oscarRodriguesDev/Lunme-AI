    ...
    return (
        ...
        {role === "PSYCHOLOGIST" ? (
          <form onSubmit={handleSubmit}>
            <div className="relative w-full max-w-screen-xl h-auto bg-[#0F1113] p-5 rounded-lg">
              {/* Header */}
              <div className="w-full h-16 bg-[#33564F] border border-[#55FF00]/30 rounded-lg flex items-center px-6 mb-8">
              ...
              <div className="mb-8">
                ...
                <hr className="border-t border-[#55FF00]/50 mb-6" />
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={userId}
                      className="w-full h-[40px] bg-[#33564F] border border-[#55FF00]/30 rounded p-2 text-[#E6FAF6]"
                      disabled
                      readOnly
                    />
                  </div>
                  ...
                  {/* Sexo */}
                  <div className="col-span-2 lg:col-span-3 bg-[#33564F] p-4 rounded-sm">
                    <label className="block text-[#E6FAF6] text-sm mb-2">Sexo:</label>
                    <div className="flex items-center gap-4">
                      <label className="flex items-center gap-1 text-[#E6FAF6]">
                        <input
                          type="radio"
                          name="sexo"
                          value="masculino"
              ...
              <div className="mb-8">
                ...
                <hr className="border-t border-[#55FF00]/30 mb-6" />
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* campos do endereço... apenas bg e text ajustados */}
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <hr className="border-t border-[#55FF00]/30 mb-6" />
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {/* campos de e-mail e telefone... apenas bg e text ajustados */}
                </div>
                <div className="col-span-2">
                  <label className="block text-[#E6FAF6] text-sm mb-1">Descrever o motivo da consulta</label>
                  <textarea
                    className="w-full h-[120px] bg-[#33564F] border border-[#55FF00]/30 rounded p-2 text-[#E6FAF6]"
